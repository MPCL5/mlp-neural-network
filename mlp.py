...
class MLP:
    ...
    def __init__(self, input_count, hidden_count, output_count, alpha):
        ...
        self.first_weights = [
            [random.random() * 2 - 1 for i in range(input_count + 1)] for j in range(hidden_count)]
        self.secound_weights = [
            [random.random() * 2 - 1 for i in range(hidden_count + 1)] for j in range(output_count)]
        self.alpha = alpha
